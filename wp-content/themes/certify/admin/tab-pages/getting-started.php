	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<h1 style="margin-top: 73px !important; font-size:2em !important; background: #0085ba;border-color: #0073aa #006799 #006799; color: #fff; padding: 10px 10px;"><?php esc_html_e( "Getting Started", 'certify' ); ?></h1>
				<div>
				...
				<p><a target="_blank" href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button button-primary" style="padding: 3px 15px;height: 40px; font-size: 16px;"><?php esc_html_e( 'Go to the Customizer','certify');?></a></p>
				</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="certify-tab-pane-half certify-tab-pane-first-half">
				<img src="<?php echo esc_url( CERTIFY_ST_TEMPLATE_DIR_URI ) . '/admin/img/certify.png'; ?>" alt="<?php esc_attr_e( 'Certify theme', 'certify' ); ?>" />
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="certify-tab-pane-half certify-tab-pane-first-half">
					...
					<a href="<?php echo esc_url('https://certify.spicethemes.com/'); ?>" target="_blank"  class="info-block"><div class="dashicons dashicons-desktop info-icon"></div>
			...
			<div class="col-md-6">
				...
				<div class="certify-tab-pane-half certify-tab-pane-first-half">
					...
					<a href="<?php echo esc_url('https://wordpress.org/support/view/theme-reviews/certify'); ?>" target="_blank"  class="info-block"><div class="dashicons dashicons-smiley info-icon"></div>
