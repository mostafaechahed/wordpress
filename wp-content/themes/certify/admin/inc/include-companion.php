...
$certify_hide_install = get_option('certify_hide_customizer_companion_notice', false);
if (!function_exists('spicethemes_companion') && !$certify_hide_install) {
	if (class_exists('WP_Customize_Section') && !class_exists('Certify_Companion_Installer_Section')) {
		...
		class Certify_Companion_Installer_Section extends WP_Customize_Section {
			...
			public static function enqueue() {
				...
				wp_enqueue_script('certify-companion-install', CERTIFY_ST_TEMPLATE_DIR_URI . '/admin/assets/js/plugin-install.js', array('jquery'));
